...
public class ServiceTestConfiguration {
	...
	public static final String EMPLOYEE_ID = "user";
	public static final String ITEM = "EMC";
	...
	//public static final String ITEM_NAME = "EMC Corp";
	...
	public static Order order() {
		...
		order1.setAccountId(EMPLOYEE_ID);
	...
	public static Portfolio portfolio() {
		...
		holding.setSymbol(ITEM);
		Portfolio folio = new Portfolio();
		folio.setAccountId(EMPLOYEE_ID);
